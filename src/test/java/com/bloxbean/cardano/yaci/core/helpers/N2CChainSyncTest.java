...
public class N2CChainSyncTest {
    ...
    void syncFromLatest() throws InterruptedException {
        ...
        N2CChainSyncFetcher chainSyncFetcher = new N2CChainSyncFetcher("/Users/satya/work/cardano-node/preview/db/node.socket", versionTable, Constants.WELL_KNOWN_PREVIEW_POINT, true);
